                    ...
                    <div class="card">
                        ...
                        @method('patch')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$user->name}}" class="form-control @error('name') is-invalid @enderror" name="name" id="Nama" aria-describedby="emailHelp" required placeholder="masuan namal">
                                 @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $user->email}}" class="form-control @error('email') is-invalid @enderror" name="email" id="nim" required aria-describedby="emailHelp" placeholder="masuan email">
                                   @error('email')
                                    <div class="invalid-feedback">
                                        {{$message}}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control @error('email') is-invalid @enderror" value="{{ $user->password}}" name="password" required id="password" aria-describedby="emailHelp" placeholder="masuan email">
                                    @error('password')
                                    <div class="invalid-feedback">
                                        {{$message}}
                                    </div>
                            ...
                            <button type="Edit User" class="btn btn-primary ml-3 ">Edit User</button>
                        </form>
                        <div class="card-body">
